    ...
    <UDashboardPanel grow>
      ...
      <UDashboardCard :ui="{ rounded: 'rounded-none' }">
        ...
        <template #links>
              ...
              <div
                ...
                <div class="px-2 pt-2 pb-2 border border-gray-200 dark:border-gray-700">
                  <div class="grid grid-cols-2 gap-2">
                    <!-- Card View Button -->
                    <button
                      class="relative flex flex-col items-center px-4 py-3 transition-colors duration-100 rounded shadow-sm ring-1 ring-inset focus:outline-none bg-gray-50 hover:bg-gray-100 dark:bg-gray-700/25 dark:hover:bg-gray-700/50 dark:text-gray-300 hover:text-gray-700"
                      :class="{
                        'ring-gray-400 dark:ring-gray-500': currentView.__name === 'homeCard',
                        'ring-gray-200 dark:ring-gray-700': currentView.__name !== 'homeCard'
                      }"
                      @click="setView('card')">
                      <UIcon name="material-symbols:responsive-layout-outline-rounded"
                    ...
                    <button
                      class="relative flex flex-col items-center px-4 py-3 transition-colors duration-100 rounded shadow-sm ring-1 ring-inset focus:outline-none bg-gray-50 hover:bg-gray-100 dark:bg-gray-700/25 dark:hover:bg-gray-700/50 dark:text-gray-300 hover:text-gray-700"
                      :class="{
                        'ring-gray-400 dark:ring-gray-500': currentView.__name === 'homeTable',
                        'ring-gray-200 dark:ring-gray-700': currentView.__name !== 'homeTable'
                      }"
                      @click="setView('table')">
          ...
          <UButton icon="mdi:database-plus-outline" label="Create Database" color="gray"
